...
*/
CREATE TABLE impressionist_object_table
(
    id serial NOT NULL,
    object_name text,
...
*/
CREATE TABLE impressionist_result_table
(
    id serial NOT NULL,
    game_id serial,
    round integer,
...
*/
CREATE TABLE impressionist_game_table
(
    id serial NOT NULL,
...
/*
*/
CREATE TABLE impressionist_user_table
(
    id serial NOT NULL,
